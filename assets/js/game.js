...
var fightOrSkip = function() {
  ...
  // change var promptFight to lower case
...
var fight = function(enemy) {
  ...
  // keep tracking of who goes first
  var isPlayerTurn = true;

  // will reassign the isPlayerTurn to false half of the time
...
var endGame = function() {
  ...
  if (playerInfo.money > highScore) {
    ...
    alert(playerInfo.name + " now has the highsore of " + playerInfo.money + "!"); 
  }
  else {
